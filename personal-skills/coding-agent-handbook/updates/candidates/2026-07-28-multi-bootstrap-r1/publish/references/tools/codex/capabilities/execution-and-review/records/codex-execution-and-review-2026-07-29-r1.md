---
record_id: codex-execution-and-review-2026-07-29-r1
tool: codex
...
这是 experimental-guidance，不是 Codex 官方行为说明。本候选没有覆盖将计划、实现、验证、审查或修复闭环归为 Codex 产品要求的官方事实；能力索引因此为 `unverified`。
