---
record_id: codex-project-instructions-2026-07-29-r1
tool: codex
...
> **FACT-codex-project-instructions-2026-07-29-r1-01**
...
> **FACT-codex-project-instructions-2026-07-29-r1-02**
...
> **FACT-codex-project-instructions-2026-07-29-r1-03**
...
本 record 是 reference，不是 Lab：本候选没有可归属的 Codex 运行时实测结果。仅在临时、无凭证、非生产的 Git 仓库中进行手工验证。建立根目录、嵌套目录和工作目录，并分别放置下列文件；文件内容仅使用可识别的非敏感文本。
