---
record_id: qoder-mcp-and-security-2026-07-29-r2
tool: qoder
...
本 record 的 `unversioned-docs-2026-07-29` 只表示官方在线文档快照，不是 Qoder 产品版本。它没有绑定公开的发行通道、客户端、平台、部署或生命周期，因此不确认版本级支持状态。

> **FACT-qoder-mcp-and-security-2026-07-29-r2-01**
...
> **FACT-qoder-mcp-and-security-2026-07-29-r2-02**
